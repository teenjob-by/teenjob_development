            ...
            <div class="row mx-0">
                ...
                <div class="col-sm-8 card-wrapper">
                    @foreach($events as $event)
                        <a class="card event-card event-card-admin" href="/events/{{$event->id}}">
                            ...
                            <table>
                                <tr>
                                    <td> <a href="{{ route('admin.events.approve', $event->id)}}" class=" {{ ($event->status == 1) ? 'disabled': '' }} btn btn-enable"><i class="fa fa-globe" aria-hidden="true"></i></a></td>

                                    <td><a href="{{ route('admin.eventsForm', $event->id)}}" class="btn btn-edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>

                                    <td><a href="{{ route('admin.events.ban', $event->id)}}" class="{{ ($event->status == 3) ? 'disabled': '' }} btn btn-disable"><i class="fa fa-ban" aria-hidden="true"></i></a></td>
