                ...
                @foreach($volunteerings as $volunteering)
                    <div class="card mt-3 card-offer">
                        <h3 class="offer-title">
                            ...
                            <table class="ml-auto">
                                <tr>
                                    <td> <a href="{{ route('admin.volunteerings.approve', $volunteering->id)}}" class="btn btn-enable"><i class="fa fa-globe" aria-hidden="true"></i></a></td>

                                    <td><a href="{{ route('admin.volunteeringForm', $volunteering->id)}}" class="btn btn-edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>

                                    <td><a href="{{ route('admin.volunteerings.ban', $volunteering->id)}}" class="btn btn-disable"><i class="fa fa-ban" aria-hidden="true"></i></a></td>
