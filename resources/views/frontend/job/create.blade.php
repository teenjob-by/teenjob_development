        ...
        <div class="content-wrapper">
            ...
            <form id="form" method="POST" class="job_form" action="{{ route('organisation.jobs.store') }}">
                ...
                <div class="job_form-group">
                    ...
                    <div class="right-aligned">
                        <input id="email" name="email" placeholder="@lang('content.job.create.email')" class="job_form-group-input @error('email') is-invalid @enderror" value="{{ old('email') }}" required autocomplete="email" autofocus>
