        ...
        <div class="content-wrapper">
            ...
            <form id="form" method="PATCH"  action="{{ route('organisation.internships.update', $internship->id) }}" class="internship_form">
                ...
                <div class="internship_form-group">
                    ...
                    <div class="right-aligned">
                        <input id="email" name="email" placeholder="@lang('content.internship.create.email')" class="internship_form-group-input @error('email') is-invalid @enderror" value="{{ $internship->email }}" required autocomplete="email" autofocus>
