        ...
        <div class="content-wrapper">
            ...
            <form id="form" method="PATCH"  action="{{ route('organisation.volunteerings.update', $volunteering->id) }}" class="volunteering_form">
                ...
                <div class="volunteering_form-group">
                    <div class="centered-title">
                        <div class="inner-icon">
                            <input id="title" onfocus="this.selectionStart = this.selectionEnd = this.value.length;" required type="text" class="volunteering_form-group-input title-input @error('title') is-invalid @enderror" name="title" placeholder="@lang('content.volunteering.update.name')" value="{{ $volunteering->title }}" autofocus>
                ...
                <div class="volunteering_form-group">
                    ...
                    <div class="right-aligned">
                        <input id="email" name="email" placeholder="@lang('content.volunteering.create.email')" class="volunteering_form-group-input @error('email') is-invalid @enderror" value="{{ $volunteering->email }}" required autocomplete="email" autofocus>
