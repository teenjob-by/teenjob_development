<div class="header {{ $shоwHeader ? 'bg-3' : 'bg-inner' }} ">
        ...
        <div class="container">
            ...
            <div class="collapse menu-collapse navbar-collapse" id="navbarsMain">
                <div class="navbar-nav ml-auto">
                    <a class="nav-link {{ ((app('request')->input('job') == 'on') || (app('request')->input('internship') == 'on') || (app('request')->input('volunteering') == 'on')) ? 'active' : '' }}" href="{{ route('frontend.offers') }}">
                        @lang('header.navlink_7')
                    </a>
                    <a class="nav-link {{ request()->routeIs('frontend.events') ? 'active' : '' }}"
                       href="{{ route('frontend.events') }}">@lang('header.navlink_3')</a>
                    <a class="nav-link {{ request()->routeIs('frontend.howsupport') ? 'active' : '' }}"
                       href="{{ route('frontend.howsupport') }}">@lang('header.navlink_4')</a>
                    <a class="nav-link {{ request()->routeIs('frontend.support') ? 'active' : '' }}"
                       href="{{ route('frontend.feedback') }}">@lang('header.navlink_8')</a>
    ...
    <div class="search-wrapper">
        ...
        <form id="main-search" class="search-box desktop-search" method="get" action="{{ route('frontend.search') }}">
            <div class="input-group mb-3">
                <div class="dropdown">
                    <select class="dropdown-menu category-dropdown" name="category">
                        <option selected class="dropdown-item" {{((app('request')->input('volunteering') == 'on') && (app('request')->input('internship') == 'on') && (app('request')->input('job') == 'on'))? 'selected': ''}} value="offers">@lang('header.categories')</option>
                        <option {{((app('request')->input('job') == 'on') && (app('request')->input('internship') !== 'on') && (app('request')->input('volunteering') !== 'on'))? 'selected': ''}} class="dropdown-item" value="job">@lang('header.navlink_6')</option>
                        <option {{((app('request')->input('internship') == 'on') && (app('request')->input('volunteering') !== 'on') && (app('request')->input('job') !== 'on'))? 'selected': ''}} class="dropdown-item" value="internship">@lang('header.navlink_1')</option>
                        <option {{((app('request')->input('volunteering') == 'on') && (app('request')->input('internship') !== 'on') && (app('request')->input('job') !== 'on'))? 'selected': ''}} class="dropdown-item" value="volunteering">@lang('header.navlink_2')</option>
                        <option {{request()->routeIs('frontend.events')? 'selected': ''}} class="dropdown-item" value="events">@lang('header.navlink_3')</option>
                    </select>
                </div>
        ...
        @endif
            ...
            @if(!((app('request')->input('volunteering') == 'on') || (app('request')->input('internship') == 'on') || (request()->routeIs('frontend.events')) || (app('request')->input('job') == 'on')))
                @if(Route::getCurrentRoute()->uri() == '/')
                ...
                @endif
            @else
                <form id="main-mobile-search" class="search-box mobile-search" method="get" action="{{ route('frontend.search') }}">
                    <div class="input-group mb-3">

                        @if((app('request')->input('volunteering') == 'on') && (app('request')->input('internship') == 'on') && (app('request')->input('job') == 'on'))
                            ...
                            <input type="hidden" name="job" value="on">
                        ...
                        @elseif(app('request')->input('internship') == 'on')
                            <input type="hidden" name="internship" value="on">
                            <input type="hidden" name="category" value="offers">
                        @elseif(app('request')->input('job') == 'on')
                            <input type="hidden" name="job" value="on">
                            <input type="hidden" name="category" value="offers">
                        @elseif(request()->routeIs('frontend.events'))
                        ...
                        @elseif(request()->routeIs('frontend.job'))
