            ...
            <div class="row">
                <div class="col-sm-12 filter-mobile closed">
                    <div class="filter-panel">
                        <form method="get" action="{{ route('frontend.offers') }}">
                            ...
                            @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <label class="custom-control overflow-checkbox">
                                            <input type="checkbox" class="overflow-control-input" {{ empty($_GET['job'])? '': 'checked="checked"'}} name="job" onchange="validate(this.form)">
                                            <span class="overflow-control-indicator"></span>
                ...
                <div class="col-sm-12 filter-mobile-compact">
                    ...
                    <form method="get" action="{{ route('frontend.offers') }}" class="filter-panel-compact">
