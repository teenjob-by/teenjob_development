            ...
            <div class="row">
                    ...
                    <div class="filter-panel">
                        <form method="get" >
                            ...
                            <div class="form-group">
                                ...
                                <!--<div class="form-check">
                                    <label class="custom-control overflow-checkbox">
                                        <input type="checkbox" class="overflow-control-input" {{ empty($_GET['job'])? '': 'checked="checked"'}} name="job" onchange="getData(getPage(), this.form)">
                                        <span class="overflow-control-indicator"></span>
                                        <span class="overflow-control-description">@lang('content.offers.search.job')</span>
                                    </label>
                                </div>-->
                            </div>
                ...
                <div class="col-sm-12 filter-mobile-compact">
                    ...
                    <form method="get"  class="filter-panel-compact">
                        ...
                        @if(!empty($_GET['job']))
                            <input type="hidden" name="internship" value="{{ $_GET['job'] }}">
                        @endif
