<template>
    <div>
        ...
        <b-card class="mt-3 " header="Создание волонтерства">
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            axios.get('/api/v1/volunteerings/create', { headers: {
        ...
        methods: {
            save() {
                var app = this;
                axios.post('/api/v1/volunteerings', qs.stringify(app.form) , { headers: {
                        'Authorization': `Bearer ` + localStorage.getItem('access_token')
                    }})
                    .then(function (resp) {
